function out = approxlev_randEig2(in)
% out = approxlev_randEig2(in)
%
...
%  score based randEig Nystrom extension to A, using l columns sampled according to
%  approximate leverage score probabilities. The first row corresponds to 
%  randEig Nystrom extensions where the rank was not fixed, the second to 
%  randEig Nystrom extensions where the rank was fixed
% 
