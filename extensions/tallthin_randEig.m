function out = tallthin_randEig(in)
% out = tallthin_randEig(in)
%
...
%  randEig sketches where the rank was not fixed, the second to sketches
...
for iter=1:in.q
    ...
    % estimate the randEig approx errors
