function plotpanel_multiplex(varargin)
%
% plotpanel_multiplex(series)
%
% Plots the information in the structure series to the current axis with a
% legend
%
% plotpanel_multiplex(series, legendflag)
%
...
%
% series.x -- a cell array containing the x values each corresponding data series should be plotted against
...
for idx = 1:length(data)
    myplot(series.x{idx}, data{idx}, styles{idx}, 'LineWidth', lw{idx}, ...
